...
const ContextProvider = ({children}) => {
  ...
  useEffect(() => {
    const authUser = async () => {
      ...
      try {
        const url = `${import.meta.env.URL_BACKEND}/api/clientes/perfil`; //mandamos get para obtener perfil
  ...
  const updateProfile = async (profile) => {
    ...
    try {
      const url = `${import.meta.env.URL_BACKEND}/api/clientes/perfil/${profile._id}`; //mandamos get para obtener perfil
  ...
  const updatePassword = async (credentials) => {
    ...
    try {
      const url = `${import.meta.env.URL_BACKEND}/api/clientes/cambiar-password`; //mandamos get para obtener perfil
